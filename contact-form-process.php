...
if (isset($_POST['Email'])) {
    ...
    $email_to = "aspecterkw@gmail.com";
    $email_subject = "New Contact";

    function problem($error)
    {
        echo "There seems to be an error with the form you submitted.";
...
?>
    ...
    Thank you for contacting me. I get in touch with you as soon as possible!
